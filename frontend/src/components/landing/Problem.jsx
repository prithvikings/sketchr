  ...
  const problems = [
    {
      ...
      description:
        "Explaining complex visual ideas over a video call or text chat is frustrating and leads to constant misunderstandings.",
      icon: "https://em-content.zobj.net/source/apple/419/speaking-head_1f5e3-fe0f.png",
    },
    {
      title: "Screen sharing is a one-way street",
      description:
        "Watching someone else draw while you just talk isn't true collaboration. It kills team creativity and momentum.",
      icon: "https://em-content.zobj.net/source/apple/419/television_1f4fa.png",
    },
    {
      title: "Scattered, dead notes",
      description:
        "Taking screenshots of virtual whiteboards and pasting them into docs makes it hard to pick up where you left off.",
    ...
    <div className="py-24 px-4 md:px-8 w-full flex flex-col items-center justify-center gap-16 font-poppins">
      ...
      <div className="heading-title flex flex-col gap-4 items-center">
        ...
        <p className="text-sm text-center text-zinc-600 max-w-md leading-relaxed">
          Current tools force you to choose between complicated design software
          or rigid, single-player note apps.
        </p>
      </div>
